...
public class NavigationController {
   ...
   /* @PostMapping(value="/convertCurrency/{countryCodeTo}",produces="application/json")
    ...
    public ResponseEntity<Mono<String>> convertCurrency(@PathVariable("countryCode") String countryCode){

            Mono<String> response =
                                 webClientBuilder.build()
                                .get()
                                .uri("http://conversion-factor/eureka/v1/getConversionFactor/AUD")
                                .retrieve()
